...
hl.exec_cmd("hyprctl dispatch submap locked")

hl.define_submap("locked", function()
	hl.bind("F12", hl.dsp.global("caelestia:lock"))
end)
...
hl.bind(
	"SUPER + CTRL + F9",
	hl.dsp.exec_cmd(
		'hyprctl eval \'hl.monitor({ output = "eDP-1", mode = "preferred", disabled = false, scale = "1" })\''
	)
)
hl.bind(
	"SUPER + CTRL + F10",
	hl.dsp.exec_cmd('hyprctl eval \'hl.monitor({ output = "HDMI-A-3", mode = "1920x1080", scale = "1" })\'')
)
...
hl.bind("CTRL + SUPER + SHIFT + ALT + R", hl.dsp.exec_cmd("hyprctl reload"))
...
hl.bind("CTRL + SUPER + SHIFT + S", hl.dsp.window.move({ workspace = "special:special" }))
hl.bind("CTRL + SUPER + SHIFT + D", hl.dsp.window.move({ workspace = "special:communication" }))
hl.bind("CTRL + SUPER + SHIFT + R", hl.dsp.window.move({ workspace = "special:todo" }))
hl.bind("CTRL + SUPER + SHIFT + M", hl.dsp.window.move({ workspace = "special:music" }))
...
hl.bind("CTRL + SUPER + SHIFT + H", hl.dsp.window.move({ workspace = "-1" }))
hl.bind("CTRL + SUPER + SHIFT + L", hl.dsp.window.move({ workspace = "+1" }))
hl.bind("CTRL + SUPER + SHIFT + ALT + H", hl.dsp.window.move({ workspace = "-10" }))
hl.bind("CTRL + SUPER + SHIFT + ALT + L", hl.dsp.window.move({ workspace = "+10" }))
hl.bind("CTRL + SUPER + H", hl.dsp.focus({ workspace = "-1" }))
hl.bind("CTRL + SUPER + L", hl.dsp.focus({ workspace = "+1" }))
hl.bind("CTRL + SUPER + ALT + H", hl.dsp.focus({ workspace = "-10" }))
hl.bind("CTRL + SUPER + ALT + L", hl.dsp.focus({ workspace = "+10" }))
...
hl.bind("SUPER + ALT + BACKSPACE", hl.dsp.exec_cmd("hyprctl kill"))
